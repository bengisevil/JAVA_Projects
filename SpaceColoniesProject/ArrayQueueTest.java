...
public class ArrayQueueTest extends TestCase {
    ...
    public void testDequeue() {
        ...
        assertEquals(11, queue1.getSize());
    ...
    public void testClear() {
        ...
        assertEquals(temp1, queue1.getFront());
        assertEquals(31, queue1.getSize());
    ...
    public void testToArray() {
        ...
        assertEquals(queue1.getSize(), queue1.toArray().length);
    }
    ...
    public void testToString() {
        ...
        queue1.enqueue(temp2);
        queue1.enqueue(temp1);
        temp2 = new Person("Jamie Doe", 1, 5, 2, "");
        queue1.enqueue(temp2);
        queue1.dequeue();
        queue1.enqueue(temp1);

        String str = "[James Doe A:1 M:5 T:2 Wants: Nars, "
            + "Jane Doe A:2 M:3 T:4 Wants: Nars, "
            + "No-Planet Jamie Doe A:1 M:5 T:2, "
            + "Jane Doe A:2 M:3 T:4 Wants: Nars]";
    ...
    public void testEquals() {
        ...
        assertFalse(queue1.equals(temp2));
