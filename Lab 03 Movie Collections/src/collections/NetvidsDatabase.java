 ...
 *
 * @author Megan Rigsbee, Xin Chen, Bengi Sevil
 * @version 2015.02.17, 2015.06.15, 2018.05.25
 */
    ...
    public Movie remove(Movie movie) {
        ...
        for (int i = 0; i < movies.length; i++) {
            ...
            if (movie.equals(movies[i])) {
                removed = movie;
                movies[i] = movies[capacity() - size];
                movies[capacity() - size] = null;
                size--;
            }
        }
        ...
        if (removed == null) {
            // Throw exception if movie is still null
